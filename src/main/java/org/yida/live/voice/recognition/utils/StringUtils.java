...
public class StringUtils {
	 ...
	 * 生成一个随机文件名称
	 *
	 * @param extension 文件扩展名（例如 "txt" 或 "wav"）
	 * @return 随机文件名称
	 */
	public static String generateRandomFileName(String extension, int fileNameLength) {
		StringBuilder stringBuilder = new StringBuilder(fileNameLength);
		...
		String currentTime = DateUtils.format(new Date(), "yyyyMMddHHmmss");
		return stringBuilder.toString() + "_" + currentTime + "." + extension;
	}
